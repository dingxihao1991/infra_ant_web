...
export default class Home extends PureComponent {
    ...
    render() {
      ...
      const P1_Html = <p style={{marginBottom: -4}}><span style={{fontSize:22}}>客流总数统计</span><label style={{marginLeft: 208,fontSize: 18}}>总人数：29993</label></p>
      const P2_Html = <span style={{fontSize:22}}>进、出站流量统计</span>
      const P3_Html = <span style={{fontSize:22}}>健康指数</span>
      const P4_Html = <span style={{fontSize:22}}>实时客流量图</span>
            ...
            <Row>
              <Col style={{marginBottom: 24}}>
                <Card title={P4_Html} bordered={false} >
                    <div id='main4' style={{ width:'90%', height: 500 }}></div>
                </Card>
              </Col>
            </Row>
