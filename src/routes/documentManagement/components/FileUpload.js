...
class userUpload extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            >
                {this.state.imageUrl ? <img src={'http://139.196.197.94/file'+this.state.imageUrl} alt="userUpload" style={{ height : "auto" , width : '132px'}}/> : uploadButton}
            </Upload>
        );
    }
}
